...
% Mean Field(DSMF)
Key_MFAB11 = variationalEM_two_coin_crowd_model(Model, 'ell', [2,1,1,1,1;1,2,1,1,1;1,1,2,1,1;1,1,1,2,1;1,1,1,1,2], 'maxIter',100, 'TOL', 1e-3);
...
[V1 V2 V3 S dist] = TenALS(A, E, r, ninit, nitr, tol);
...
result2 =  MinimaxEntropy_crowd_model(Model,'algorithm','categorical',opts{:});
