...
% Mean Field(DSMF)
Key_MFAB11 = variationalEM_two_coin_crowd_model(Model, 'ell', [2,1;2,1], 'maxIter',100, 'TOL', 1e-3);
...
for i=1:Ni
    T(Nw+1,i,Key_MFAB11.ans_labels(i))=1;
end
